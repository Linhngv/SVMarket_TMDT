    ...
    useEffect(() => {
        const loadActiveListings = async () => {
            try {
                ...
                // Lấy 4 sản phẩm đề xuất
                setActiveListings([...data].reverse().slice(0, 4));
            } catch (error) {
    ...
    return (
        <div className="product-section mt-4">
            <div className="product-header">
                <h5 className="product-title">Đề xuất sản phẩm</h5>
            </div>
                    ...
                    <div className="col-6 col-md-4 col-lg-3 mb-3" key={item.key}>
                        ...
                        >
                            ...
                            <div className="product-img-wrapper">
                                {item.image ? (
                                    <img src={item.image} alt="" className="product-img" onError={(e) => (e.currentTarget.style.display = "none")} />
                                ) : (
